...
public class BinaryLiterals {
	...
	public static void main(String[] args) {
        ...
        short s1 = 0b110;   // Using b0, The b can be lower or upper case  
        short s2 = 0B110;   // Using B0  
        System.out.println("----------Binary Literal in Short----------------");  
        System.out.println("s1 = "+s1);  
        System.out.println("s2 = "+s2);  
          
        // Binary literal in int type  
        int i1 = 0b10;     // Using b0, The b can be lower or upper case  
        int i2 = 0B10;     // Using B0  
